...
const FEATURED_RECIPES = [
  {
    id: 1,
    title: "Нежный суп-пюре с тыквой",
    age: "1–3 года",
    time: "25 мин",
    difficulty: "Просто",
    emoji: "🎃",
    desc: "Бархатистый и сладковатый, дети обожают его цвет и вкус",
    color: "bg-orange-50",
  },
  {
    id: 2,
    ...
    difficulty: "Просто",
    emoji: "🍗",
    desc: "Мягкие, сочные и очень питательные — без лишних специй",
    color: "bg-amber-50",
  },
  {
    id: 3,
    title: "Манная каша с ягодным пюре",
    age: "8 мес–2 года",
    time: "15 мин",
    difficulty: "Легко",
    emoji: "🍓",
    desc: "Нежная каша с ярким фруктовым вкусом — завтрак мечты",
    color: "bg-rose-50",
  },
  {
    id: 4,
    ...
    difficulty: "Средне",
    emoji: "🥕",
    desc: "Сытное и мягкое блюдо, богатое витаминами",
    color: "bg-green-50",
  },
  {
    id: 5,
    ...
    difficulty: "Просто",
    emoji: "🍌",
    desc: "Нежная, воздушная и сладкая — без сахара и муки",
    color: "bg-yellow-50",
  },
  {
    id: 6,
    ...
    difficulty: "Просто",
    emoji: "🍚",
    desc: "Согревающий и лёгкий суп как в детском саду",
    color: "bg-blue-50",
  },
];
...
const Index = () => {
  ...
  const ages = ["Все", "8 мес–2 года", "1–3 года", "1–4 года", "2–5 лет", "1–6 лет"];
